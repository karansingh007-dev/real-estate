...
const CommunityCard = ({ title, tagline, details, image, onClick }) => {
  return (
    <div
      className="bg-white shadow rounded overflow-hidden transition-transform duration-300 hover:scale-105 cursor-pointer"
      onClick={onClick}
    >
      <div className="relative">
        <img src={image} alt={title} className="w-full h-60 object-cover" />

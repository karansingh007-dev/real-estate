...
const HomePage = () => {
  return (
    <div
      id="home"
      className="w-full min-h-screen p-8 flex items-center bg-white"
    >
      <div className=" mx-auto md:flex md:flex-col md:items-center">
        <div className="w-full h-screen md:p-8 my-11">
          <img src={Image} alt="Home" className="w-full h-auto object-cover " />
        </div>
